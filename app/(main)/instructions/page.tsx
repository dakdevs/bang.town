export default function InstructionsPage() {
  return (
    <div className="space-y-8 font-sans">
      ...
      <div>
        <h2 className="text-2xl mb-4 text-primary bangers">Chrome-based Browser Setup</h2>
        <div className="space-y-4">
          ...
          <div className="bg-surface p-4 rounded-lg">
            <h3 className="font-semibold mb-2 bangers">3. Add Custom Search Engine</h3>
      ...
      <div>
        <h2 className="text-2xl mb-4 text-primary bangers">Arc Browser Setup</h2>
        <div className="space-y-4">
          <div className="bg-surface p-4 rounded-lg">
      ...
      <div className="bg-surface p-4 rounded-lg border border-primary-light">
